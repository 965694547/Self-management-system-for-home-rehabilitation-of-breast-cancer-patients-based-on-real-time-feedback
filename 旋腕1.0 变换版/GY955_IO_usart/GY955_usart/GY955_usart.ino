...
unsigned char Re_buf[30],counter=0;//state1=0;
unsigned char sign=0;
int16_t DATA[7],counter1=0;
...
void qz_function()
{
  if(abs(Original_ROLL-ROLL)<=10&&Attitude.Gyro_Speed_Z<10.0)
   state1=1;
   if(abs(Original_ROLL-ROLL)>=110&&Attitude.Gyro_Speed_Z<10.0&&(state1==1))
   {
    state1=0;
    qz++;
   }
