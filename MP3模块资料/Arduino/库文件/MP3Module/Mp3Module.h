...
private:
  ...
  static Mp3Module *active_object;
...
public:
  // public methods
  Mp3Module(uint8_t transmitPin, uint8_t receivePin, uint8_t busyPin, bool inverse_logic = false);
  ~Mp3Module();
  void Play(unsigned char num,bool wait_no);
  void Stop(void);
  void VolumeSet(unsigned char Volnum);
  void Next(void);
  void Last(void);
